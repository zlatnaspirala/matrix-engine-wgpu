...
import {mesh} from './stanfordDragon.js';
import {vertexShadowWGSL} from './vertexShadow.wgsl.js';
import {vertexWGSL} from './vertex.wgsl.js';
import {fragmentWGSL} from './fragment.wgsl.js';
...
self.addEventListener('message', (ev) => {
  switch (ev.data.type) {
    case 'init': {
      try {
        run(ev.data.offscreenCanvas, ev.data.devicePixelRatio);
      } catch (err) {
        console.error(
...
async function run(canvas, devicePixelRatio) {
