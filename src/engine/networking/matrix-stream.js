      ...
      session.connect(token)
        .then(() => {
          ...
          var publisher = OV.initPublisher('video-container', {
            ...
            videoSource: (netConfig.isDataOnly ? false : undefined), // The source of video. If undefined default webcam
            publishAudio: !netConfig.isDataOnly, // Whether you want to start publishing with your audio unmuted or not
            publishVideo: !netConfig.isDataOnly, // Whether you want to start publishing with your video enabled or not
...
export function fetchInfo(sessionName) {
  httpRequest('POST',
