...
export function checkingRay(object) {
  ...
  try {
    ...
    // ???
    ray = unproject([touchCoordinate.x, touchCoordinate.y], [0, 0, touchCoordinate.w, touchCoordinate.h], mat4.invert(outp, object.projectionMatrix), mat4.invert(outv, mvMatrix));
