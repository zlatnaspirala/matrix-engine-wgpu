export const sprite2dSlotMashine = `

EXAMPLE Sprite2d Anim, Slot mashine construction and simple spining

import {
  MatrixEngineWGPU, downloadMeshes,
  addRaycastsAABBListener, randomIntFromTo,
  GenGeoTexture2, initializeSpritesForMesh, SpritesPack2D,
  InstancedKinematicOperations, animateRotationY, KaleidoscopeEmitter
